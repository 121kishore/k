...
final class Database
{
    public static function tables(): array
    {
        ...
        return [
            ...
            'options' => $wpdb->prefix . 'skpq_options',
    ...
    public static function create_tables(): void
    {
        ...
        dbDelta("CREATE TABLE {$tables['questions']} (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, quiz_id BIGINT UNSIGNED NOT NULL, question LONGTEXT NOT NULL, explanation LONGTEXT NULL, explanation_image VARCHAR(255) NULL, explanation_video VARCHAR(255) NULL, difficulty ENUM('easy','medium','hard') DEFAULT 'medium', points INT UNSIGNED DEFAULT 1, status TINYINT(1) DEFAULT 1, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id), KEY quiz_id (quiz_id), KEY difficulty (difficulty), KEY status (status)) $charset;");
        dbDelta("CREATE TABLE {$tables['options']} (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, question_id BIGINT UNSIGNED NOT NULL, option_text LONGTEXT NOT NULL, is_correct TINYINT(1) DEFAULT 0, sort_order INT UNSIGNED DEFAULT 0, PRIMARY KEY (id), KEY question_id (question_id), KEY is_correct (is_correct)) $charset;");
        ...
        dbDelta("CREATE TABLE {$tables['results']} (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, attempt_id BIGINT UNSIGNED NOT NULL, question_id BIGINT UNSIGNED NOT NULL, selected_option_id BIGINT UNSIGNED NULL, correct_option_id BIGINT UNSIGNED NULL, is_correct TINYINT(1) DEFAULT 0, score DECIMAL(6,2) DEFAULT 0, created_at DATETIME NOT NULL, PRIMARY KEY (id), KEY attempt_id (attempt_id), KEY question_id (question_id)) $charset;");
