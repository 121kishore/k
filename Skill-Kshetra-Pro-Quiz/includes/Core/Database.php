...
final class Database
{
    ...
    public static function create_tables(): void
    {
        ...
        dbDelta("CREATE TABLE {$tables['results']} (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, attempt_id BIGINT UNSIGNED NOT NULL, question_id BIGINT UNSIGNED NOT NULL, selected_answer_id BIGINT UNSIGNED NULL, correct_answer_id BIGINT UNSIGNED NULL, is_correct TINYINT(1) DEFAULT 0, created_at DATETIME NOT NULL, PRIMARY KEY (id), KEY attempt_id (attempt_id)) $charset;");
