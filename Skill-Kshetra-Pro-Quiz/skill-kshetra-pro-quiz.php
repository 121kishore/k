 ...
 * Description: Structured WordPress quiz plugin foundation with admin quiz CRUD, frontend, models, and custom database services.
 * Version: 0.1.0
 * Author: Kwork
...
require_once SKPQ_PLUGIN_DIR . 'src/Core/Autoloader.php';
